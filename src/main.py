...
# Error handling for inputs
		try: 
			...
			# Sends user to room selection function 
			room_select() 
# Home function 
def home():
...
def room_select():
	...
	if number == '1': 
		...
		# Appends room type to room variable
		room.append('Room type: Peasant Quarter') 
		# Appends cost to cost variable
...
# Error handling for user inputs    
    while True:
        try: 
            ...
            # Skips to date function if user inputs 0
            if year == 0: 
                set_checkin_date()
                break  
            elif year < 2023:
                ...
                while True:
                    ...
                    if 1 <= month <= 12:
						# Prints calendar for month and year selected
...
def set_checkin_date():
    ...
    while True: 
        ...
        try:
			# Splits input and maps to checkin_date_entry into year, month, day 
            ...
            if checkin_date < today:
				...
				# Appends checkin date to checkin variable 
